"""
Django settings for Nanobernetics project.
...
SECRET_KEY = 'hf(*qfr0vq#1rau(b5yhfyfd*zew!_$o__#nc5-2g4^6-_yc=0'
...
ROOT_URLCONF = 'Nanobernetics.urls'
...
WSGI_APPLICATION = 'Nanobernetics.wsgi.application'
